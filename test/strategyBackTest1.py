...
def main(code="600070", start_cash=1000000, stake=100, commission_fee=0.001):
    ...
    stock_hfq_df = ak.stock_zh_a_hist(symbol=code, adjust="hfq", start_date='20020616', end_date='20220617').iloc[:, :6]
    ...
    start_date = datetime(2002, 6, 16)  # 回测开始时间
    end_date = datetime(2022, 6, 17)  # 回测结束时间
